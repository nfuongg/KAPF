...
const images = {
  hero: assetPath("kanhbg.jpg"),
  aboutFeature: assetPath("kanh1.jpg"),
  aboutPortrait: assetPath("kanh2.jpg"),
  ...
  return (
    <main className="max-w-[1920px] w-full mx-auto relative bg-background overflow-clip font-heading text-[#3A2E2A]">
      ...
      <motion.section
        ...
        <img className="w-full h-full object-cover shadow-[inset_0_0_0_1px_#3A2E2A]" src={images.hero} alt="Không gian công nghệ" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 text-center px-4">
          ...
          <motion.p
            ...
            Sinh viên Tiếng Việt và Văn hóa Việt Nam · ULIS-VNU
          </motion.p>
        </div>
      </motion.section>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-8">
            <motion.div
              ...
              <p className="text-[clamp(16px,1.3vw,22px)] font-normal leading-[1.7] text-primary">
                Tôi là <strong> Đường Kiều Anh</strong>, sinh viên ngành <strong>Tiếng Việt và Văn hóa Việt Nam</strong>, Trường Đại học Ngoại ngữ – Đại học Quốc gia Hà Nội. 
                Tôi yêu thích học hỏi, khám phá những kiến thức mới và ứng dụng công nghệ số, đặc biệt là AI, vào học tập và cuộc sống. Bên cạnh đó, tôi tích cực tham gia các hoạt động ngoại khóa để rèn luyện kỹ năng giao tiếp, làm việc nhóm và phát triển bản thân.
              </p>
              <p className="text-[clamp(16px,1.3vw,22px)] font-normal leading-[1.7] text-primary">
                Sở thích của tôi bao gồm: nghe nhạc, sáng tạo nội dung, tham gia các hoạt động cộng đồng và tìm hiểu những xu hướng công nghệ mới. Tôi luôn mong muốn học hỏi, lan tỏa những giá trị tích cực và không ngừng chinh phục những mục tiêu mới trên hành trình phát triển của mình.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              <div className="flex flex-col gap-3">
                {[
                "Nâng cao năng lực sử dụng công nghệ số và các công cụ trí tuệ nhân tạo để hỗ trợ học tập, nghiên cứu và làm việc hiệu quả.",
                "Phát triển kỹ năng tìm kiếm, đánh giá và xử lý thông tin một cách khoa học, chính xác và có trách nhiệm.",
                "Rèn luyện khả năng sáng tạo nội dung số, giao tiếp và hợp tác trong môi trường số thông qua các dự án và hoạt động nhóm.",
                "Không ngừng trau dồi kiến thức chuyên môn, kỹ năng mềm và tinh thần học hỏi để chuẩn bị hành trang cho công việc trong tương lai."].
                map((goal, i) =>
          ...
          <div className="flex flex-col gap-8">
            ...
            <motion.div
              ...
              <div className="flex flex-col gap-3">
                {[
                "Ghi lại quá trình học tập, thực hành và những kỹ năng số đã tích lũy trong học phần",
                "Lưu trữ các sản phẩm, bài tập và minh chứng học tập một cách khoa học, giúp dễ dàng theo dõi, chia sẻ và cập nhật khi cần.",
                "Thể hiện sự tiến bộ của bản thân thông qua việc vận dụng công nghệ số và trí tuệ nhân tạo vào học tập, nghiên cứu và các hoạt động thực tiễn.",
                "Xây dựng một hồ sơ học tập (Digital Portfolio) chuyên nghiệp, làm nền tảng để tiếp tục phát triển kiến thức, kỹ năng và định hướng nghề nghiệp trong tương lai."].
                map((item, i) =>
                <div key={i} className="flex flex-row items-start gap-3">
                    <div className="w-2 h-2 bg-secondary rounded-full mt-2 shrink-0" />
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                  <div className="relative">
                    <img src={images.aboutPortrait} className="w-[100px] md:w-[141px] h-[100px] md:h-[141px] rounded-full object-cover shadow-[inset_0_0_0_1px_#F0EBE3] z-[3] relative" alt="Ảnh chân dung" />
                  ...
                  <div className="flex flex-col gap-2 md:gap-4 text-center md:text-left">
                    <p className="text-[clamp(22px,2.08vw,40px)] font-bold text-primary"> Đường Kiều Anh</p>
                    ...
                    <p className="text-[14px] md:text-[18px] font-bold text-primary">Sinh viên Tiếng Việt và Văn hóa Việt Nam · Năm 1 · ULIS-VNU</p>
                  </div>
                </div>
              </div>
...
className="flex flex-col rounded-[20px] overflow-hidden shadow-[inset_0_0_0_1px_#3A2E2A] bg-[#FFEFEF] hover:bg-[#F0EBE3] transition-all duration-300 group">
              ...
              <div className="p-6 flex flex-col gap-4 flex-1">
                <div>
                  ...
                  <p className="text-[clamp(14px,1.1vw,18px)] font-light leading-[1.6] text-[#3A2E2A]/80">{assignment.goal}</p>
                </div>

                <div>
                  <p className="text-[13px] font-bold text-secondary uppercase tracking-widest mb-2">📋 Tóm tắt</p>
                  <p className="text-[clamp(14px,1.1vw,18px)] font-light leading-[1.6] text-[#3A2E2A]/80">{assignment.summary}</p>
                </div>

                <div className="flex flex-wrap gap-2 mt-auto pt-2">
                  {assignment.tags.map((tag, j) =>
                <span key={j} className="py-1 px-3 rounded-full shadow-[inset_0_0_0_1px_#F3D0D7] text-[12px] font-bold text-[#3A2E2A] bg-[#F3D0D7]/70">
                      {tag}
                    </span>
                )}
                </div>
      ...
      <section id="set-up" className="mt-[clamp(38px,7.8vw,150px)] mx-4 md:mx-[clamp(16px,2.8vw,53px)] grid grid-cols-1 xl:grid-cols-[832fr_910fr] gap-[clamp(20px,5.2vw,100px)] z-10 relative">
        ...
        <div className="flex flex-col gap-[clamp(16px,3.2vw,62px)]">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-[clamp(16px,1.5vw,24px)] font-normal leading-[1.6] text-[#3A2E2A]/70">Những công cụ tôi sử dụng hàng ngày trong học tập và làm việc</p>
          </div>
        ...
        <div className="flex flex-col gap-8 relative">
          <motion.div
            ...
            <img src={images.setupMain} className="w-full h-full object-cover rounded-[20px] shadow-[inset_0_0_0_8px_#F0EBE3] md:shadow-[inset_0_0_0_18px_#F0EBE3]" alt="Không gian làm việc" />
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <motion.div
              ...
              className="flex flex-col gap-4 p-2.5 bg-accent rounded-[15px] w-full">
                ...
                <img src={src} className="w-full aspect-[270/164] object-cover rounded-[20px] shadow-[inset_0_0_0_4px_#F0EBE3]" alt="Chi tiết thiết lập" />
              </motion.div>
            )}
          </div>
        </div>
            ...
            <motion.div
              ...
              className="flex flex-col gap-4 pt-6 border-t-[2px] border-[#3A2E2A]/20 group cursor-pointer">
                ...
                <div className="flex flex-row flex-wrap gap-2">
                  {post.tags.map((tag, j) =>
                <span key={j} className="py-1 px-3 rounded-full shadow-[inset_0_0_0_1px_#F3D0D7] text-[12px] font-bold text-[#3A2E2A] bg-[#F3D0D7]/70">{tag}</span>
                )}
                  <span className="text-[13px] text-[#3A2E2A]/50 font-light self-center ml-2">{post.date}</span>
                </div>
                <p className="text-[clamp(18px,1.5vw,26px)] font-extrabold group-hover:text-secondary transition-colors">{post.title}</p>
                <p className="text-[clamp(14px,1.2vw,20px)] font-light leading-[1.7] text-[#3A2E2A]/70">{post.excerpt}</p>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            <div className="flex flex-col gap-4">
              ...
              map((item, i) =>
              <div key={i} className="flex flex-row items-start gap-3 p-4 bg-[#FFEFEF] rounded-[12px]">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1220fr_582fr] gap-[clamp(16px,2.6vw,50px)] xl:gap-[clamp(20px,5.2vw,100px)]">
          ...
          <motion.div
            ...
            <div className="flex flex-col gap-[21px]">
              ...
              <a href="mailto:duongkieuanh642007@gmail.com" className="text-[clamp(16px,1.8vw,32px)] font-normal hover:text-secondary transition-colors break-all">duongkieuanh642007@gmail.com</a>
              <p className="text-[clamp(14px,1.5vw,24px)] font-normal text-[#3A2E2A]/80">0848364183</p>
            </div>
      ...
      <footer className="mt-[clamp(38px,7.8vw,150px)] mx-4 md:mx-12 mb-12 flex flex-col lg:flex-row justify-between items-center gap-10 z-10 relative border-t border-[#3A2E2A]/20 pt-10">
        <div className="flex flex-row items-center gap-[clamp(16px,2.1vw,40px)] md:gap-[clamp(19px,4.9vw,95px)]">
          ...
          <p className="text-[clamp(20px,2.34vw,45px)] font-extrabold">Kiều Anh</p>
        </div>
